      ...
      <div className="container mx-auto px-4 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Input Box */}
            <div className="flex items-center bg-white rounded-full px-5 py-3 mt-8 max-w-lg shadow-lg">
              {/* Email Icon */}
              ...
              <input
                ...
                className="flex-1 px-4 bg-transparent outline-none text-gray-700 text-lg"
              />
          ...
          {/* Links */}
          <div>
            <h3 className="text-2xl font-semibold mb-5">Footer Menu</h3>
        ...
        {/* Bottom */}
        <div className="border-t border-gray-700 mt-12 pt-6 text-center text-gray-500 text-base">
